sap.ui.define([
		...
		return BaseObject.extend("crm.mkt.cpg.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias crm.mkt.cpg.model.ListSelector
			 */
			 ...
			 * @return {crm.mkt.cpg.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
