/*global history */
sap.ui.define([
		"crm/mkt/cpg/controller/BaseController",
		...
		return BaseController.extend("crm.mkt.cpg.controller.Master", {
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("ExternalId", FilterOperator.Contains, sQuery)];
				} else {
