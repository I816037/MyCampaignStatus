sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("crm/mkt/cpg/app", ".html");
			sHash = sHash || "";
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#MyCampaignStatus-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#MyCampaignStatus-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("crm.mkt.cpg.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["crm/mkt/cpg/localService/mockserver"], function (mockserver) {
